        ...
        <el-dialog title="审核详情" :visible.sync="addDialog.dialogShow">
				<el-form :model="addDialog">
                    ...
                    <el-form-item label="性别" :label-width="formLabelWidth">
                        <el-select v-model="addDialog.sex">
                    ...
                    <el-form-item label="注册渠道" :label-width="formLabelWidth">
						<el-input v-model="addDialog.channel" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="注册时间" :label-width="formLabelWidth">
						<el-input v-model="addDialog.addtime" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="累计通话时长" :label-width="formLabelWidth">
						<el-input v-model="addDialog.accumulate_time" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="累计通话收益" :label-width="formLabelWidth">
						<el-input v-model="addDialog.call_ticket" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="累计礼物收益" :label-width="formLabelWidth">
						<el-input v-model="addDialog.gift_ticket" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="累计其它收益" :label-width="formLabelWidth">
						<el-input v-model="addDialog.other_ticket" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="随机通话次数" :label-width="formLabelWidth">
						<el-input v-model="addDialog.rand_num" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="好友通话次数" :label-width="formLabelWidth">
						<el-input v-model="addDialog.friend_num" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="累计充值金额" :label-width="formLabelWidth">
						<el-input v-model="addDialog.total_pay_money" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="历史提现次数" :label-width="formLabelWidth">
						<el-input v-model="addDialog.history_cash_times" auto-complete="off"></el-input>
					</el-form-item>
                    <el-form-item label="历史提现金额" :label-width="formLabelWidth">
						<el-input v-model="addDialog.history_cash_money" auto-complete="off"></el-input>
					</el-form-item>
				</el-form>
    ...
    methods:{
        ...
        Auditing(index, rows) { // 审核详情按钮
            ...
            .then(res => {
                _this.listLoading = false;                
                if(res.data.ret) {
                    _this.addDialog.num = res.data.num;
