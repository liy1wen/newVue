<template>
	...
	<section>
		...
		<template>
            ...
            <el-dialog title="录音信息" :visible.sync="dialogFormVisible" center>
                ...
                <span slot="footer" class="dialog-footer">
                    <el-button @click="cancleDialogFormVisible = false">取 消</el-button>
    ...
    export default {
		...
		methods: {
            ...
            cancleRecommend() {
                var _this = this;
				var id = row.id;
				var url = '/Voice/cancelShareHotVoiceData';
				var params = {
					id: id,
				};
