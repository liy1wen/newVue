...
// 设置活动正式服数据
let officialBase = 'https://manage.dianliaoapp.com/ydlManage/server/index.php';
...
// 只请求正式服数据方法
export const officialAllet = (params, url) => {return axios.get(`${officialBase}`+url, { params: params });};